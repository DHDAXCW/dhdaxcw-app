...
const FAN_PWM_FILE_PLACEHOLDER = '/sys/class/hwmon/hwmon0/pwm1';                            // 默认风扇PWM控制文件路径
const FAN_SPEED_FILE_PLACEHOLDER = '/sys/class/hwmon/hwmon0/fan1_input';                    // 默认风扇速度读取文件路径
...
return view.extend({
    ...
    render: async function(data) {
        ...
        // 风扇速度读取文件路径配置
        o = s.option(form.Value, 'fan_speed_file', _('Fan Speed File'), _('Path to the fan speed reading file (e.g., /sys/class/hwmon/hwmon0/fan1_input)'));
